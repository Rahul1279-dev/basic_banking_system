...
def login_menu(user_id,id,password,pos,user_details):
...
def view_data(user_id,id,password,pos,user_details):
...
def update_data(user_id,id,password,pos,user_details):
